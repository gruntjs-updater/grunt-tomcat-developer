...
If true, the plugin will tail the catalina.out file generated by the tomcat
instance and output contents to the grunt log asynchronously. Use with the
`watch` task and see tomcat console output at the same time as watch output.
